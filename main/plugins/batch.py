...
@Savvy.on(events.NewMessage(incoming=True, from_users=AUTH, pattern='/cancel'))
...
@Savvy.on(events.NewMessage(incoming=True, from_users=AUTH, pattern='/batch'))
